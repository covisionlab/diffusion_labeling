...
def main():
    ...
    #  python gen_metric_fid.py  /mnt/NAS20/quality/paper_benchmarks/wood_defect_detection/syndata4cv_cvpr25/splits/real_20.csv  /mnt/NAS20/quality/paper_benchmarks/wood_defect_detection/syndata4cv_cvpr25/splits/layout_20.csv output_here --batch_size 256 --device cuda    
